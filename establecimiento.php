  ...
  <div class="row">
    <div class="col-sm-2">
      ...
      <ul class="nav nav-pills flex-column">
        ...
        <li class="nav-item">
          <a class="nav-link" href="actulizaestablecimiento.php">Actualizar Establecimiento</a>
        </li>
        <li class="nav-item">
    ...
    <?php
      ...
      && (isset($_POST['DIRECCION']) && !empty($_POST['DIRECCION']))){
        ...
        $query = "INSERT INTO `establecimientos` (ID_ESTABLECIMIENTO, NOM_ESTABLECIMIENTO, TELEFONO, DIRECCION) VALUES ('$ID_ESTABLECIMIENTO', '$NOM_ESTABLECIMIENTO', '$TELEFONO', '$DIRECCION')";
        ...
        <div class="container-fluid">
          <div  class="container py-5">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Ingrese nombre establecimiento" id="NOM_ESTABLECIMIENTO" name="NOM_ESTABLECIMIENTO" required>
              </div>    
            </div>
