...
$query_Recordset1 = "SELECT * FROM detalle_factura ORDER BY ID_DETALLE_FACTURA";
...
<table border="3" width="1000" bordercolor="#0000FF"  style="font-size:12px" bgcolor="#FFFFFF">  <tr>
    <td><h3>ID DETALLE FACTURA</h3></td>
    <td><h3>ID FACTURA</h3></td>
...
?>
    <tr>
      <td ><?php echo $row_Recordset1['ID_DETALLE_FACTURA'];  ?></td>
      <td ><?php echo $row_Recordset1['ID_FACTURA'];  ?></td>
      <td ><?php echo $row_Recordset1['ID_EMPLEADO'];  ?></td>
      <td ><?php echo $row_Recordset1['ID_PLATO'];  ?></td>
      <td ><?php echo $row_Recordset1['ID_MESA'];  ?></td>
