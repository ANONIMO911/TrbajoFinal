  ...
  <div class="row">
    <div class="col-sm-2">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="actualizarplato.php">Actualizar Plato</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="eliminarplato.php">Eliminar Plato</a>
        </li>
        <li class="nav-item">
    ...
    <?php
      ...
      && (isset($_POST['NOM_PLATO']) && !empty($_POST['NOM_PLATO']))
      && (isset($_POST['PRECIO_PLATO']) && !empty($_POST['PRECIO_PLATO']))){

        $ID_PLATO = $_POST['ID_PLATO'];
        $NOM_PLATO = $_POST['NOM_PLATO'];
        $PRECIO_PLATO = $_POST['PRECIO_PLATO'];
        
        
        

        $query = "UPDATE `platos` SET NOM_PLATO = '$NOM_PLATO', PRECIO_PLATO = '$PRECIO_PLATO' WHERE ID_PLATO = '$ID_PLATO'";
        ...
        <div class="container-fluid">
          <div  class="container py-5">
					<form class="form-contact" method="POST">
						<h2 class="form-contact-heading">Actualizar los datos</h2>
            ...
            <div class="form-group">
              <label for="NOM_PLATO">Nombre Plato:</label>
              <div class="input-group">
              <div class="input-group-prepend">
                <span class="input-group-text bg-light"><i class="fas fa-users"></i></span>
              </div>
              <input type="text" class="form-control" placeholder="Nombre del plato" id="NOM_PLATO" name="NOM_PLATO" required>
              </div>    
            </div>
            ...
            <label for="PRECIO_PLATO">Precio Plato:</label>
              ...
              <input type="text" class="form-control" placeholder="Valor del plato" id="PRECIO_PLATO" name="PRECIO_PLATO" required>
              </div>    
            </div>
