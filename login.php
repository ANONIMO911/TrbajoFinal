          ...
          <div  class="container py-5">
            ...
            <label for="cedula">Cedula:</label>
              <div class="input-group">
                ...
                <input type="number" class="form-control" placeholder="Ingrese su cedula" id="cedula" name="cedula" required>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" placeholder="Ingrese su nonbre completo" id="nombre" name="nombre" required>
              </div>    
            </div>
