  ...
  <div class="row">
    <div class="col-sm-2">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="eliminarestablecimiento.php">Eliminar Establecimiento</a>
        </li>
        <li class="nav-item">
    ...
    <?php
      ...
      if((isset($_POST['ID_ESTABLECIMIENTO']) && !empty($_POST['ID_ESTABLECIMIENTO']))){
        ...
        $query = "DELETE FROM `establecimientos`  WHERE ID_ESTABLECIMIENTO = '$ID_ESTABLECIMIENTO'";
        ...
        <div class="container-fluid">
          <div  class="container py-5">
					<form class="form-contact" method="POST">
						<h2 class="form-contact-heading">Ingresa tus datos para eliminar</h2>
