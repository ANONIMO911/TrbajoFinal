...
$query_Recordset1 = "SELECT * FROM establecimientos ORDER BY ID_ESTABLECIMIENTO";
...
<h3>LISTADO DE ESTABLECIMIENTO</h3>
...
<table border="3" width="1000" bordercolor="#0000FF"  style="font-size:12px" bgcolor="#FFFFFF">  <tr>
    ...
    <td><h3>NOMBRE ESTABLECIMIENTO</h3></td>
...
?>
    <tr>
      ...
      <td ><?php echo $row_Recordset1['NOM_ESTABLECIMIENTO'];  ?></td>
...
<a href="establecimiento.php" style="text-decoration: none rgb(20, 20, 20);" >Regresar</a>
</div>
<hr/>
</article>
</section>
