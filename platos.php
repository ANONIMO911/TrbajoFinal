...
<div class="container" style="margin-top: 30px;">
  <div class="row">
    <div class="col-sm-2">
      ...
      <li class="nav-item">
          <a class="nav-link active" href="platos.php">Ingresar Platos</a>
        </li>
        <li class="nav-item">
    ...
    <?php
      ...
      && (isset($_POST['PRECIO_PLATO']) && !empty($_POST['PRECIO_PLATO']))){
        ...
        $query = "INSERT INTO `platos` (ID_PLATO, NOM_PLATO, PRECIO_PLATO) VALUES ('$ID_PLATO', '$NOM_PLATO', '$PRECIO_PLATO')";
        ...
        <div class="container-fluid">
          <div  class="container py-5">
					<form class="form-contact" method="POST">
						<h2 class="form-contact-heading">Ingresa los datos</h2>
